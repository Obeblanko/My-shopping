...
const HomePage = () => {
    return (
        <div>
            <Header />
            <Navbar  showAbout={true} showProducts={true} showShop={true} showContact={true}   />

            
            <div className="container mx-auto my-8">
                <h1 className="text-4xl font-bold mb-4">Discover Amazing Deals in Our Online Store</h1>

                <p className="text-lg mb-6">
                    Uncover a vast selection of products and seize incredible offers on the latest trends in fashion, electronics, and more.
                </p>
